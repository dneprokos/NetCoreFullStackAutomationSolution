...
namespace Dneprokos.Movies.Api.Client.RequestsBuilder.Base
{
    public class MoviesRequestBuilderBase : BaseApiClient
    {
        ...
        protected KeyValuePair<string, string> DefaultAcceptHeader = new("Accept", "application/json");
        protected KeyValuePair<string, string> DefaultContentType = new("Content-Type", "application/json");
